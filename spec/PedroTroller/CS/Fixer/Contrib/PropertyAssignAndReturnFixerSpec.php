...
class PropertyAssignAndReturnFixerSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType('PedroTroller\CS\Fixer\Contrib\PropertyAssignAndReturnFixer');
    }

    function it_returns_its_name()
    {
        $this->getName()->shouldReturn('property_assign_and_return');
    }
